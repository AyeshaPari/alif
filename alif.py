...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mALIF AYAN              \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mALIF AYAN           \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m Alif Ayan1       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+01612044601            \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m4.0                       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m  NO CHANNEL       \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎FACEBOOK TRICKS AND HELPING ZONE [EMRAN]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
\033[31;44m EVERYONE THINKS OF ALIF AYANCHANGING THE WORLD     
 BUT NO ONE THINKS OF ALIF AYAN CHANGING HIMSELF.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mARMAN-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mARMAN-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : ALIF AYAN ")
    print("\t  Fb group   : Muslim cyber security  ")
    print("\t  Github   : arman3")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To ALIF-AYAN-TEAM Tool ....")
        time.sleep(2)
    ...
    my_server=requests.get("https://www.facebook.com/Arman.Admin.tremux.group/posts/pfbid02ZG78gghaeEdjhr1Vo6MyvoHcPZkrCZcpH3ycnoEsswzLdVF5aZ8GueSYoHZxazael/?app=fbl").text
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp +8801318805859\n")
        print(" Copy your Key :",gre,f_token+_help,wit,"\n")
        os.system("xdg-open https://www.facebook.com/Arman.Admin.tremux.group")
        exit()
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_MD ARMAN HOSSAIN _RANDOM_CLONE_TOOL.mp3")
    os.getuid
